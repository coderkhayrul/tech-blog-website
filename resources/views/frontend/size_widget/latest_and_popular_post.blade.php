                        ...
                        <div class="post post-small post-list education-post post-separator-border">
                            <div class="post-wrap">
                                ...
                                <div class="content">
                                    ...
                                    <!-- Title -->
                                    <h5 class="title"><a href="@if(session()->get('language') == 'bangla') {{ route('post.show',$post->slug_en) }} @else {{ route('post.show',$post->slug_en) }} @endif ">@if(session()->get('language') == 'bangla') {{ $post->name_ban }} @else {{ $post->name_en }} @endif</a></h5>
