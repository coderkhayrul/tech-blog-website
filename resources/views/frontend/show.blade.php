                                    ...
                                    <div class="post post-overlay hero-post">
                                        <div class="post-wrap">
                                            ...
                                            <div class="content">
                                                ...
                                                <!-- Title -->
                                                <h4 class="title"><a href="@if(session()->get('language') == 'bangla') {{ route('post.show',$post->slug_en) }} @else {{ route('post.show',$post->slug_en) }} @endif ">@if(session()->get('language') == 'bangla') {{ Str::limit($post->name_ban, 40, $end='.') }} @else {{ Str::limit($post->name_en, 40, $end='.') }}@endif</a></h4>
