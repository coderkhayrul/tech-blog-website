            ...
            <div class="col-lg-8 col-12 mb-50">
                ...
                <div class="post-block-wrapper">
                    ...
                    <div class="head education-head">
                        <!-- Title -->
                        <h4 class="title"> @if(session()->get('language') == 'bangla') পোস্ট অনুসন্ধান ফলাফল <span class="badge badge-danger">{{ count($posts) }}</span> @else Post Search Result <span class="badge badge-danger">{{ count($posts) }}</span> @endif </h4>
