        ...
        <div class="card-header">
            <div class="row align-items-center">
                ...
                <div class="col text-right">
                    <a href="{{ route('admin.profile.view') }}" class="btn btn-sm btn-primary"><i class="fas fa-angle-left"></i> Back Profile</a>
                </div>
            </div>
        </div>
    ...
    <div class="card border-light shadow-sm">
        ...
        <div class="card-body bg-white border-light shadow-sm mb-4">
            ...
            <div class="user-avatar xl-avatar mb-3">
                <img class="rounded" id="mainThmb" src="{{ $profile->profile_image != NULL ? asset($profile->profile_image) : asset('backend').'/assets/img/team/profile-picture-3.jpg' }}" alt="change avatar">
            </div>
