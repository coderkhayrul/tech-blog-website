        ...
        <div class="card-header">
            <div class="row align-items-center">
                ...
                <div class="col text-right">
                    <a href="{{ route('admin.profile.edit') }}" class="btn btn-sm btn-primary"><i class="fas fa-user-edit"></i> Edit Profile</a>
                </div>
            </div>
        </div>
        <div class="card-body">
                ...
                <div class="col-12 mb-4">
                    <div class="card border-light text-center p-0">
                        ...
                        <div class="card-body pb-5">
                            <img src="{{ $profile->profile_image != NULL ? asset($profile->profile_image) : asset('backend').'/assets/img/team/profile-picture-3.jpg' }}" class="user-avatar large-avatar rounded-circle mx-auto mt-n7 mb-4" alt="Neil Portrait">
